...
# Bot information
SESSION = environ.get('SESSION', 'VOIDITH')
API_ID = int(environ.get('26359840', ''))
API_HASH = environ.get('edab829f5470b93013fa380740dc3538', '')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5987443826').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002585086941').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002562265306')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002590645205').split()]  # For Multiple Id Use One Space Between Each.
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'wafavg') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.


# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/voidith')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/voidithch')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'voidith_ds') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/voidith')
